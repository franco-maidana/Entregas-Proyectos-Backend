...
import Usuarios from "../data/mongo/users.model.js";
...
export default class CustomRouter {
  ...
  response(req, res, next) {
    ...
    res.error401 = () => res.json({ statusCode: 401, message: "bad auth aca" });
    res.error403 = () => res.json({ statusCode: 403, message: "forbbiden" });
    res.error404 = () => res.json({ statusCode: 404, message: "not fount" });
    return next();
  }
