...
class ProductsControllers {
  ...
  create = async (req, res, next) => {
    try {
      const data = req.body;
      const response = await this.sevice.create(data);
  ...
  read = async (req, res, next) => {
    try {
      ...
      const all = await this.sevice.read({ filter, orderAndPaginate });
  ...
  readOne = async (req, res, next) => {
    try {
      ...
      const all = await this.sevice.readOne(eid);
      return res.success200(all);
    } catch (error) {
      return next(error);
    }
  ...
  upDate = async (req, res, next) => {
    try {
      const { eid } = req.params;
      const data = req.body;
      const response = await this.sevice.update(eid, data);
      return res.success200(response);
    } catch (error) {
      return next(error);
    }
  ...
  destroy = async (req, res, next) => {
    try {
      const { eid } = req.params;
      const response = await this.sevice.destroy(eid);
      return res.success200(response);
    } catch (error) {
      return next(error);
    }
